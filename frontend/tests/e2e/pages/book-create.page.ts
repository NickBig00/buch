...
export class BookCreatePage {
	...
	async expectOnPage() {
		await expect(this.page.locator('mat-toolbar').getByText(/neues buch/i)).toBeVisible({ timeout: 15_000 });
	}

	async createMinimalBook(params: { titel: string; isbn13: string; rating?: number; preis: number }) {
